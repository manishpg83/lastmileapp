<div class="container-xxl container-p-y">
    <div class="card">
        <div class="card-body">
            ...
            <p class="text-body-secondary mb-4">Upload your Excel or CSV file containing customer names, dockets, and
                addresses.</p>
            ...
            <form wire:submit.prevent="upload">
                <div class="border border-2 border-dashed rounded p-5 mb-4 text-center" x-data="{ dragging: false }"
                    x-on:dragover.prevent="dragging = true" x-on:dragleave.prevent="dragging = false"
                    x-on:drop.prevent="dragging = false">
                    <input type="file" x-ref="fileInput" wire:model="file" accept=".xlsx,.xls,.csv" class="d-none"
                        id="upload-file">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="text-body-secondary small mb-0">
                            Ensure all required fields are present in the first sheet. Systems will auto-assign
                            "Pending" status to all records.
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary" wire:loading.attr="disabled"
                        wire:target="upload,file" @disabled(!$file)>
