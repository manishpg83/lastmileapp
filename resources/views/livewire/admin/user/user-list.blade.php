    ...
    <div class="container-xxl container-p-y">
        ...
        <div class="card drivers-wrap">
            <div
                ...
                <div
                    class="d-flex flex-column flex-sm-row gap-2 align-items-stretch align-items-sm-center w-100 w-md-auto">
                    {{-- Search Box --}}
                ...
                @forelse($users as $user)
                    <div class="row align-items-center px-4 py-3 border-bottom g-0 driver-row">
                        ...
                        <div class="col-md-3 col-6 d-flex align-items-center gap-3">
                            @if ($user->profile_image_url)
                                <img src="{{ $user->profile_image_url }}"
                                    class="rounded-circle border border-2 driver-avatar" style="object-fit: cover;"
                                    alt="{{ $user->name }}">
                            @else
                            ...
                            @endif
                            <div class="truncate">
                                <strong class="d-block text-heading text-truncate"
                        ...
                        <div class="col-md-2 col-6">
                            <label class="d-md-none text-muted fw-bold d-block mb-1"
                                style="font-size:0.7rem;">CONTACT</label>
                        ...
                        <div class="col-md-3 col-6 mt-3 mt-md-0">
                            <label class="d-md-none text-muted fw-bold d-block mb-1"
                                style="font-size:0.7rem;">VEHICLE</label>
                            <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="col-md-2 col-3 text-end mt-3 mt-md-0">
                            <label class="d-md-none text-muted fw-bold d-block mb-1"
                                style="font-size:0.7rem;">ACTIONS</label>
